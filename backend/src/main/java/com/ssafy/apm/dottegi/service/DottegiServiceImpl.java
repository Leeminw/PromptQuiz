...
//    private final long timerDuration = 300000;
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public void sendTopMessageImage() throws IOException {
...
//        String base64Image = "data:image/png;base64," + sdwResponseDto.getImages().get(0);

        /* TODO: RDB에 저장 or 파일로 저장하여 불러와서 Base64 인코딩 하여 전송하는 방식 */
