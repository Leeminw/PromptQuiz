  ...
  return (
    <div className="flex flex-col items-center w-1/2">
      ...
      <div className="w-2/3 flex flex-col gap-4 min-w-[24rem] px-10">
        ...
        <button
          className="btn-mint hover:brightness-125 transition mt-1 animate-loginbtn py-[0.2rem]"
          onClick={loginUser}
        >
          로그인
        </button>
        <button
          className="btn-white hover:brightness-125 transition mt-1 animate-loginbtn py-[0.2rem]"
          onClick={() => {
            navigate('/join');
          }}
        >
